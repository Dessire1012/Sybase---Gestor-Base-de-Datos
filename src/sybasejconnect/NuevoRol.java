 ...
 * @author dessi
 */
public class NuevoRol extends javax.swing.JDialog {

    /**
     * Creates new form Registroo
     */
    public NuevoRol(java.awt.Frame parent, boolean modal, String id_Creador, String lastId) {
        super(parent, modal);
        initComponents();
    ...
    private NuevoRol(JFrame jFrame, boolean b) {
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        try {                                     
            ...
            try {
                call = con.prepareCall("Exec sp_Rol_create("+crear+")");
                call.executeUpdate();
            ...
            Logger.getLogger(NuevoRol.class.getName()).log(Level.SEVERE, null,ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NuevoRol dialog = new NuevoRol(new javax.swing.JFrame(), true);
