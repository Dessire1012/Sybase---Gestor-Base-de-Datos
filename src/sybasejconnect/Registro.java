...
public class Registro extends javax.swing.JDialog {
     ...
     */
    public Registro(java.awt.Frame parent, boolean modal, String id_Creador, String lastId) {
        super(parent, modal);
        initComponents();
    ...
    private Registro(JFrame jFrame, boolean b) {
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        try {                                     
            ...
            crear += Integer.toString(id) + "," + nombre + "," + clave + "," + id_creador;
            
            try {
                call = con.prepareCall("Exec sp_Usuario_create("+crear+")");
                call.executeUpdate();
